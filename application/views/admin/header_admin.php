...
<head>
    ...
    <!-- Title Page-->
    <title>SIPP-Balitbang Provinsi Riau Admin</title>
                ...
                <ul class="list-unstyled navbar__list">
                    ...
                    <li>
                        <a href="<?= base_url() ?>admin/Pemohon">
                            <i class="fas fa-user"></i>Data Pemohon</a>
                    </li>
                    <li class="has-sub">
                        <a class="js-arrow" href="#">
                            <i class="fas fa-check-circle"></i>Validasi</a>
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            <li>
                                <a href="<?= base_url() ?>admin/validasipemohon">Pemohon</a>
                            </li>
                            <li>
                                <a href="<?=base_url()?>admin/validasiproposal">Proposal</a>
                            </li>

                        </ul>
                    </li>
                    <li>
                        <a href="<?=base_url()?>admin/seminar">
                            <i class="fas fa-table"></i>Seminar</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>admin/history">
                            <i class="fas fa-history"></i>History Pengajuan</a>
                    </li>
                </ul>
            </nav>
        </div>
                                ...
                                <div class="account-item clearfix js-item-menu">
                                    ...
                                    <div class="account-dropdown js-dropdown">
                                        <div class="info clearfix">
                                            <div class="image">
                                                <a href="#">
                                                    <img src="<?= base_url() ?>assets/templates/images/icon/riau.png" alt="John Doe" width="40px"/>
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h5 class="name">
